...
activities = {
    ...
    "Soccer Team": {
        "description": "Train for games and practice team soccer skills",
    ...
    "Drama Club": {
        ...
        "max_participants": 20,
        "participants": ["sara@mergington.edu", "eli@mergington.edu"]
    },
    "Art Studio": {
    ...
    "Science Olympiad": {
        "description": "Prepare for science competitions through labs and study groups",
        "schedule": "Mondays, 4:00 PM - 5:30 PM",
        "max_participants": 14,
        "participants": ["jade@mergington.edu", "dylan@mergington.edu"]
    }
}
